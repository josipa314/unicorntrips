...
// UPDATE ONE AGENCY: display form
router.get("/:agencyId/edit", isLoggedIn, (req, res, next) => {
  const id = req.params.agencyId;
...
router.post("/:agencyId/edit", isLoggedIn, fileUploader.single("imageFile"), (req, res, next) => {
    const id = req.params.agencyId;
...
// DELETE that Agency:
router.post("/:agencyId/delete", isLoggedIn, (req, res, next) => {
  const id = req.params.agencyId;
